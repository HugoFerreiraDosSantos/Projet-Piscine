...
<html>
	...
	<body>
		<div id="page-wrapper">
			...
			<div id="main">
				<div class="container">
					<h1 style = "text-align : center;"><a href="forms/rechercheRelationMessage.php" class="button">Rechercher une relation</a></h1></br></br></br>
					...
					<?php
	         				...
	         				while($resultat = $resultats->fetch(PDO::FETCH_OBJ))
						{
							...
							echo '<h2><a href="forms/readMessages.php?id='.$resultat->id_friend.'&img2='.$resultat->path.'" class="button">Envoyer un message</a></h2>';
							echo '</section></div>';
						}
